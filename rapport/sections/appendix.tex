...
\begin{center}
    \begin{minted}[linenos, breaklines, firstnumber=1,baselinestretch=1.2,breakanywhere]{javascript}
...
\begin{center}
    \begin{minted}[linenos, breaklines, firstnumber=1,baselinestretch=1.2]{javascript}
...
\begin{center}
    \begin{minted}[linenos, breaklines, firstnumber=1,baselinestretch=1.2]{jsx}
