...
Overall this is a simple representation of the sytems workflow, but it helps indicate the procress from selecting a beer to actually getting the product.